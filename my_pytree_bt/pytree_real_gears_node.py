...
# BASE_WAYPOINT_OBJECTS = [[2.7, 0.0], [2.2, 3.4]]
# BASE_WAYPOINT_OBJECTS = [[2.7, 0], [2.2, 3.4], [-0.8, 2.7], [-0.5, 0]] #RAMP PHYSICS
BASE_WAYPOINT_OBJECTS = [[10.6, 0], [10.6, 2.2], [-0.5, 2.2], [-0.5, 44]]
LINEAR_VEL = 0.50
ANGULAR_VEL = 0.05
ROTATION_VEL = 0.2
# LINEAR_VEL = 0.0
...
def main():
    ...
    tree.tick_tock(period_ms=250.0)
